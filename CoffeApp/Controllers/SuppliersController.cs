...
namespace CoffeApp.Controllers
{
    ...
    public class SuppliersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,PhoneNumer,Mail")] Supplier supplier)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,PhoneNumer,Mail")] Supplier supplier)
        {
            if (id != supplier.Id)
            {
                return NotFound();
